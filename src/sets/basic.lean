import hott.hit.quotient hott.algebra.relation hott.types.nat.order hott.function types.prop_axioms types.tuple
...
/- Equalities between two sets also correspond to bijections between the two sets. 
   ...
   in [str_id]. They do not calculate particularly well when applied to
